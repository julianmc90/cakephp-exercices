 ...
 */
	 ...
	 *
	 */
	public function asset_js($js){
		foreach($js as $j){
			$route = $this->webroot.'assets/'.$this->params['controller'].'/js/'.$j.'.js';
	 ...
	 *
	 */
	public function asset_css($css){
		foreach($css as $cs){
			$route = $this->webroot.'assets/'.$this->params['controller'].'/css/'.$cs.'.css';
			echo "<link rel='stylesheet' type='text/css' href='".$route."'>";  	
		}
	}
